namespace BlazorApp1.Services
{
    ...
    catch (WebDriverTimeoutException)
    {
        ...
        return;
            ...
            int partitionCount = Math.Min(25, rowCount);
            ...
            int startIndex = 1;
            Console.WriteLine($"threads{partitionCount}");
		...
		courseOptions.AddArgument("--disable-dev-shm-usage");
			...
			IJavaScriptExecutor js = (IJavaScriptExecutor)driver;
                        ...
                        {
                        try{
                        Console.WriteLine("button click fail trying javascript");
                        js.ExecuteScript("arguments[0].click();",subjectElement);
                        }
                        catch{
                        Console.WriteLine("javascript failed skipping for now");
                        continue;
                        }
                        }
                    ...
                    try
    {
        ...
        public static CourseDescriptionDetails LoadCourseDescriptionDetails(ChromeDriver driverInstance)
        {
            ...
            {
                Thread.Sleep(5000);
                var wait = new WebDriverWait(driverInstance, TimeSpan.FromSeconds(20));
